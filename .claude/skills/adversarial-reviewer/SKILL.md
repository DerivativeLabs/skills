...
description: "Argue against proposed actions to test judgment quality. Not \"is the code correct\" but \"should we be doing this at all?\" Aligned with robustness, not performance.. Use when: review, adversarial, challenge"
category: quality
sync: all
---
